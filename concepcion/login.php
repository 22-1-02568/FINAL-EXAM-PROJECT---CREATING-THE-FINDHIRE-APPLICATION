    ...
    <div class="main">
        <div class="login_form_container">
            ...
            <form action="core/handleForms.php" method="POST" id="form">
                ...
                <input type="text" name="email" class="login_email" 
                       style="font-size: 1.5em; border: 1px solid #FFB74D; border-radius: 5px;" required>
                <br><br>
            ...
            <p style="margin-top: 3em;">Don't have an account? Register 
                <a href="register.php" style="color: #64B5F6; text-decoration: none;">here</a>!</p>
        </div>
